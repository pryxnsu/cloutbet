...
export default function ErrorUI({ error, refresh }: { error: string; refresh?: () => void }) {
  return (
    <div className="flex min-h-100 flex-col items-center justify-center space-y-6 p-8 text-center">
